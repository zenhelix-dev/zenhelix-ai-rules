---
name: backend-patterns-kotlin
description: "Kotlin implementation patterns for backend architecture. Use with `backend-patterns` skill for foundational concepts."
targets: ["claudecode"]
claudecode:
  model: sonnet
---

# Backend Architecture Patterns — Kotlin
