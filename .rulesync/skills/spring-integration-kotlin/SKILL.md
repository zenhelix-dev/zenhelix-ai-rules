---
name: spring-integration-kotlin
description: "Kotlin implementation patterns for Spring Integration. Use with `spring-integration` skill for foundational concepts."
targets: ["claudecode"]
claudecode:
  model: sonnet
---
